...
FILE_AGENT_PROMPT_SPECS = {
    ...
    for item in (
        _spec(
            ...
            "916b6f8792d52fba70bbc73c64ee5373bd0d024c510957d63f22a9332a0aaae6",
            "project_id",
            "workspace_schema",
        ),
        _spec(
        ...
        _spec(
            ...
            "d771638006c61a88824e566081b77e7977cb6d30e2fe23398789eaf780e6ff2d",
            "project_id",
            "workspace_schema",
        ),
        _spec(
            ...
            "10e218088c59a6b74f8e3973754fbc1547500e9f9cca559f7da9c6fd2062d7cb",
            "project_id",
            "workspace_schema",
            "content_type",
