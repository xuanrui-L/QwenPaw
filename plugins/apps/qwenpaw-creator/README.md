...
- **Video generation**:
  - DashScope / Bailian: `wan2.7` and `happyhorse-1.1` derive t2v / i2v / r2v model siblings from an explicitly selected element type; Bailian also hosts the `kling/kling-v3-*` and r2v-only `vidu/viduq3-*_reference2video` models;
